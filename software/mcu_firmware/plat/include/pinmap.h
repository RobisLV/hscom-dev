...
#define INT_SPI_MISO_FUNC0		ADDRESS_OF(P2SEL0)
#define INT_SPI_MISO_FUNC1		ADDRESS_OF(P2SEL1)
#define INT_SPI_MOSI_FUNC0		ADDRESS_OF(P2SEL0)
#define INT_SPI_MOSI_FUNC1		ADDRESS_OF(P2SEL1)
#define INT_SPI_SCK_FUNC0   	ADDRESS_OF(P2SEL0)
#define INT_SPI_SCK_FUNC1   	ADDRESS_OF(P2SEL1)
...
#define INT_SPI_FLASH_SS_FUNC0  ADDRESS_OF(P2SEL0)
#define INT_SPI_FLASH_SS_FUNC1  ADDRESS_OF(P2SEL1)
